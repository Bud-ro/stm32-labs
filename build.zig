...
const labs = [_][]const u8{ "lab-03", "lab-04", "lab-05", "lab-06", "lab-07", "lab-08", "lab-09" };
...
pub fn build(b: *std.Build) void {
    ...
    const install = selected_install orelse {
        std.debug.print("error: unknown -Dlab={s}; expected one of: lab-03, lab-04, lab-05, lab-06, lab-07, lab-08, lab-09\n", .{selected_lab});
        std.process.exit(1);
    };
